...
* We exported and deployed our BBU detection model to phones with Android OS.
...
## Model Deployment
In consideration of technical privacy of CMCC, we are sorry that the final model is not availbale. However, we provide source code of our APP without the model. A video is presented below to show our APP:
